...
describe('SVG Icon Parsing', () => {
  it('1. Lucide Check (path-only) → should be VectorNode', async () => {
    ...
    const root = await parseHtmlToNodesViaIframe(html, 'Test')
  ...
  it('2. Lucide Info (circle+path) → expect ImageFill fallback', async () => {
  ...
  it('3. Lucide Star (complex path) → should be VectorNode', async () => {
  ...
  it('4. Heroicons Heart (filled, complex path) → should be VectorNode', async () => {
  ...
  it('5. Lucide Mail (rect+path) → expect ImageFill fallback', async () => {
  ...
  it('6. Arrow Right (multi-path) → should be VectorNode', async () => {
  ...
  it('7. Icon inside button with text', async () => {
  ...
  it('8. Circle + path icon → VectorNode with correct dimensions', async () => {
    const html = `<div>
  ...
  it('9. Rect element → converted to path in VectorNode', async () => {
    const html = `<div>
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
  ...
  it('10. Ellipse + line icon → VectorNode', async () => {
    const html = `<div>
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
  ...
  it('11. Polygon (star) → VectorNode with correct structure', async () => {
    const html = `<div>
