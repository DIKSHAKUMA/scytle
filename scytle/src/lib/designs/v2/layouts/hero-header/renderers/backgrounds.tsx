 ...
 *
 * Hero-header background layers include a dark overlay (40% opacity)
 * for text readability, matching the Figma hero designs.
 * Identical to Header backgrounds — separate file for category isolation.
 */
