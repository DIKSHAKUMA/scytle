/**
 * Header — Universal Parametric Section Renderer
 *
 * One component handles all header variants via config-driven rendering.
 * 4 shell types:
 ...
 *   card         — section → container(1280) → bordered card(foreground bg, h-640) → blocks
...
export interface HeaderSectionShellProps extends LayoutProps {
    config: HeaderPresetConfig
}

export function HeaderSectionShell({ sectionId, blocks, className, config }: HeaderSectionShellProps) {
    ...
    // ── Container / bg-container shells (Families A, B, C) ──
