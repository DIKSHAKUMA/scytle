...
/**
 * Blog Section Split Family — Blog section with heading pinned left, posts flowing right.
 * For embedding in pages (Blog 61-64 designs).
 *
 * Controls:
 * - itemCount: 2 | 3 | 4
 * - showImage: boolean
...
const defaultExcerpts = Array.from({ length: 4 }, () => 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.')
...
export const BlogSectionSplitFamily: TemplateFamily = {
    id: 'blog-section-split',
    category: 'blog',
    name: 'Blog Section Split',
    description: 'Blog section with heading pinned left and posts flowing right',
    tags: ['blog', 'section', 'split', 'embedded'],
    hasImage: true,
    Canvas,
    controlsDef: [
        {
