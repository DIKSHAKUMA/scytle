...
const DEFAULT_HTML = `
<section class="w-full bg-[#FAF8F5] py-32 px-8 text-center" style="font-family: 'Plus Jakarta Sans', sans-serif;">
  <div class="max-w-4xl mx-auto">
    <div class="w-20 h-20 bg-[#EBE5DF] rounded-full flex items-center justify-center mx-auto mb-8">
      <svg class="w-8 h-8 text-[#2A3B32]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
    </div>
    <h2 class="text-[#1C1C1C] text-5xl lg:text-7xl font-medium mb-8 leading-tight" style="font-family: 'Playfair Display', serif;">
      Where will your <br/>story <span class="italic text-[#D47A53]">take you?</span>
    </h2>
    <p class="text-[#5C6B61] text-xl mb-12 leading-relaxed max-w-2xl mx-auto">
      Connect with a Lumina travel designer to begin crafting a signature journey that defies expectations.
    </p>
    <button class="bg-[#1C1C1C] text-[#FAF8F5] px-10 py-5 rounded-full text-lg font-semibold tracking-wide hover:bg-[#D47A53] transition-colors duration-300">
